import { toErrorMessage } from 'orbit/base/common/errorMessage';
import { Emitter, Event } from 'orbit/base/common/event';
import { Disposable, IDisposable } from 'orbit/base/common/lifecycle';
import { isWindows } from 'orbit/base/common/platform';
import { URI } from 'orbit/base/common/uri';
import { IEnvironmentService } from 'orbit/platform/environment/environment';
import { createDecorator } from 'orbit/platform/instantiation/instantiation';
