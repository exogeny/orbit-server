...
import { CancellationError } from 'orbit/base/common/errors';
import { ISplice } from 'orbit/base/common/sequence';
...
export function equals<T>(one: ReadonlyArray<T> | undefined, other: ReadonlyArray<T> | undefined,
