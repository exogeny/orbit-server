import * as arrays from 'orbit/base/common/arrays';
import * as types from 'orbit/base/common/types';
import * as nls from 'orbit/nls';
import { IAction } from 'orbit/base/common/actions';

function exceptionToErrorMessage(exception: any, verbose: boolean): string {
  if (verbose && (exception.stack || exception.stacktrace)) {
    return nls.localize(
      'stackTrace.format', '{0}: {1}', detectSystemErrorMessage(exception),
...
function detectSystemErrorMessage(exception: any): string {
  ...
  if (typeof exception.code === 'string' && typeof exception.errno === 'number'
